...
import '../widgets/beneficiary_card.dart' show FullImageViewer;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          // عرض الصورة — قابلة للنقر للتكبير
                          Builder(builder: (ctx) {
                            final hasNew = _img != null;
                            final hasOld = _b.imagePath != null &&
                                _b.imagePath!.isNotEmpty &&
                                File(_b.imagePath!).existsSync();
                            final hasAny = hasNew || hasOld;
                            final activePath =
                                hasNew ? _img!.path : (hasOld ? _b.imagePath! : null);

                            return InkWell(
                              borderRadius: BorderRadius.circular(12),
                              onTap: activePath == null
                                  ? null
                                  : () {
                                      showDialog(
                                        context: ctx,
