    ...
    showDialog(
      ...
      builder: (c) => AlertDialog(
        ...
        content: const Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('💻 نسخة Windows — تطبيق التقارير المتقدمة v11.02'),
          SizedBox(height: 8),
          Text('الإصدار: 11.2.0 (نسخة سطح المكتب)'),
          Text('دعم عربي RTL + تقارير PDF + إحصائيات متقدمة'),
          Text('🆕 تكبير الصور بالنقر + تبويب مستفيدين بدون صور'),
          Text('🆕 تحسين اتجاه RTL للمحضر على جميع إصدارات Word'),
