...
class BeneficiaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final icon  = _statusIcons[beneficiary.status]  ?? Icons.home_rounded;
            final hasImage = beneficiary.imageFileName != null &&
        beneficiary.imageFileName!.isNotEmpty &&
        (!kIsWeb
            ? (beneficiary.imagePath != null &&
              ...
              child: hasImage
                  ? ClipRRect(
                      ...
                      child: BeneficiaryImage(
                        imagePath: beneficiary.imagePath,
                        imageFileName: beneficiary.imageFileName,
                        width: 48, height: 48,
                        fit: BoxFit.cover,
                        placeholder: Icon(icon, color: color, size: 26),
                      ))
